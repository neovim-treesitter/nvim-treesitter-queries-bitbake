# nvim-treesitter-queries-bitbake

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bitbake/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bitbake/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bitbake**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-bitbake",
...
- [ ] Changes are scoped to `bitbake` — do not include files for other languages
